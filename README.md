...
|------------------------------------------------------|----------------------|------------|--------------------------|-------------------------------------------------------------------------|
| [v0.13](https://github.com/cilium/hubble/tree/v0.13) | 2024-03-11 (v0.13.2) | Yes        | Cilium 1.15 and older    | [GitHub Release](https://github.com/cilium/hubble/releases/tag/v0.13.2) |
