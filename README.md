...
|----------------------------------------------------|---------------------|------------|--------------------------|------------------------------------------------------------------------|
| [v0.9](https://github.com/cilium/hubble/tree/v0.9) | 2021-11-30 (v0.9.0) | Yes        | Cilium 1.11 and older    | [GitHub Release](https://github.com/cilium/hubble/releases/tag/v0.9.0) |
