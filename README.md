...
|------------------------------------------------------|----------------------|------------|--------------------------|-------------------------------------------------------------------------|
| [v0.11](https://github.com/cilium/hubble/tree/v0.11) | 2023-03-15 (v0.11.3) | Yes        | Cilium 1.13 and older    | [GitHub Release](https://github.com/cilium/hubble/releases/tag/v0.11.3) |
