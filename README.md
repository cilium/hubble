...
|------------------------------------------------------|----------------------|------------|--------------------------|-------------------------------------------------------------------------|
| [v1.17](https://github.com/cilium/hubble/tree/main)  | 2025-02-12 (v1.17.1) | Yes        | Cilium 1.17 and older    | [GitHub Release](https://github.com/cilium/hubble/releases/tag/v1.17.1) |
