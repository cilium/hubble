...
|------------------------------------------------------|----------------------|------------|--------------------------|-------------------------------------------------------------------------|
| [v1.16](https://github.com/cilium/hubble/tree/main)  | 2025-01-22 (v1.16.6) | Yes        | Cilium 1.16 and older    | [GitHub Release](https://github.com/cilium/hubble/releases/tag/v1.16.6) |
