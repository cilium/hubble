...
|------------------------------------------------------|----------------------|------------|--------------------------|-------------------------------------------------------------------------|
| [v0.12](https://github.com/cilium/hubble/tree/v0.12) | 2023-10-11 (v0.12.1) | Yes        | Cilium 1.14 and older    | [GitHub Release](https://github.com/cilium/hubble/releases/tag/v0.12.1) |
