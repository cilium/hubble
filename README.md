...
|------------------------------------------------------|----------------------|------------|--------------------------|-------------------------------------------------------------------------|
| [v1.16](https://github.com/cilium/hubble/tree/main)  | 2024-10-04 (v0.16.2) | Yes        | Cilium 1.16 and older    | [GitHub Release](https://github.com/cilium/hubble/releases/tag/v1.16.2) |
