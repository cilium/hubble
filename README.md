...
|----------------------------------------------------|---------------------|--------------------------|------------------------------------------------------------------------|
| [v0.7](https://github.com/cilium/hubble/tree/v0.7) | 2020-10-19 (v0.7.0) | Cilium 1.9, Cilium 1.8   | [GitHub Release](https://github.com/cilium/hubble/releases/tag/v0.7.0) |
