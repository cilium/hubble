...
|------------------------------------------------------|----------------------|------------|--------------------------|-------------------------------------------------------------------------|
| [v0.11](https://github.com/cilium/hubble/tree/v0.11) | 2023-01-24 (v0.11.1) | Yes        | Cilium 1.13 and older    | [GitHub Release](https://github.com/cilium/hubble/releases/tag/v0.11.1) |
